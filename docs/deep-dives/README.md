...
- [workspace-state-and-worktree-lifecycle.md](./workspace-state-and-worktree-lifecycle.md)：`WorkspaceSession`、文件 before/after snapshot、FS/git/hunk rewind、durable checkpoint 与 worktree fork/apply/remove。
